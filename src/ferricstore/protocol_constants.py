...
_COMPACT_FLOW_QUERY_RESULT = 0xA0
...
_COMPACT_STREAM_XADD_PIPELINE_MODE = 34


_COMPACT_PUBSUB_PUBLISH_PIPELINE_MODE = 35
...
_SAFE_CONTROL_RETRY_COMMANDS = frozenset(
    {
        "FLOW.QUERY",
        "FLOW.QUERY.INDEXES",
        "OPTIONS",
