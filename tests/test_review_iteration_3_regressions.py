...
_INVALID_GOVERNANCE_CALLS: list[tuple[str, tuple[Any, ...], dict[str, Any], str]] = [
    ...
    (
        "schedule_create",
        ("schedule-1",),
        {"target": {"type": "job", "id": "job-1"}, "at_ms": 9_007_199_254_740_992},
        "at_ms",
    ),
    (
        "schedule_create",
    ...
    (
        "schedule_create",
        ("schedule-1",),
        {"target": {"type": "job", "run_at_ms": 9_007_199_254_740_992}},
        "run_at_ms",
    ),
    (
        "schedule_create",
        ("schedule-1",),
        {"target": {"type": "job", "unknown": True}},
        "unknown",
    ),
    (
        "schedule_create",
        ("schedule-1",),
        {"target": {"type": "job", "id": "fixed", "id_prefix": "generated"}},
        "id_prefix",
    ),
    (
        "schedule_create",
        ("schedule-1",),
        {"target": {"type": "job"}, "kind": "one_shot", "every_ms": 1},
        "every_ms",
    ),
    (
        "schedule_create",
    ...
    (
        ...
        ("schedule-1",),
        {
            "target": {"type": "job", "id_prefix": "job"},
            "kind": "interval",
            "every_ms": 9_007_199_254_740_992,
        },
        "every_ms",
    ),
    (
    ...
    (
        "schedule_fire_due",
        (),
        {"now_ms": 9_007_199_254_740_990, "lease_ms": 2},
        "lease_ms",
    ),
    (
        "schedule_create",
    ...
    (
        "schedule_create",
        ("schedule-1",),
        {"target": {"type": "job"}, "catchup_policy": "fire_once"},
        "catchup_policy",
    ),
    (
        "schedule_create",
    ...
    (
        "schedule_create",
        ("schedule-1",),
        {"target": {"type": "job"}, "overlap_retry_ms": 1},
        "overlap_retry_ms",
    ),
    (
        "schedule_create",
    ...
    ("schedule_list", (), {"state": "unknown"}, "state"),
    ...
    ("schedule_list", (), {"from_ms": 2, "to_ms": 1}, "from_ms"),
